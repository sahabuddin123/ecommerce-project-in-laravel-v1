@extends('user.app')
@section('title') Cart | E-commerce-Shopping @endsection
@section('content')
<!-- ========================= SECTION PAGETOP ========================= -->
                        ...
                        <table class="table table-hover shopping-cart-wrap">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <figure class="media">
                                            <div class="img-wrap"><img src="{{ asset('/frontend/images/items/1.jpg') }}" class="img-thumbnail img-sm"></div>
                                ...
                                <tr>
                                    <td>
                                        <figure class="media">
                                            <div class="img-wrap"><img src="{{ asset('/frontend/images/items/2.jpg') }}" class="img-thumbnail img-sm"></div>
                                            <figcaption class="media-body">
                                                <h6 class="title text-truncate">Product name goes here </h6>
                                                <dl class="dlist-inline small">
                                                    <dt>Size: </dt>
                                ...
                                <tr>
                                    <td>
                                        <figure class="media">
                                            <div class="img-wrap"><img src="{{ asset('/frontend/images/items/3.jpg') }}" class="img-thumbnail img-sm"></div>
                                            <figcaption class="media-body">
                                                <h6 class="title text-truncate">Product name goes here </h6>
                                                <dl class="dlist-inline small">
                                                    <dt>Size: </dt>

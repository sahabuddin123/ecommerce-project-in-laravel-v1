@extends('user.app')
@section('title') Product-detail | E-commerce-Shopping @endsection
@section('content')
                            ...
                            <aside class="col-sm-5 border-right">
                                <article class="gallery-wrap">
                                    <div class="img-big-wrap">
                                        <div>
                                            <a href="{{ asset('/frontend/images/items/1.jpg') }}" data-fancybox=""><img src="{{ asset('/frontend/images/items/1.jpg') }}"></a>
                                        </div>
                                    </div>
                                    <!-- slider-product.// -->
